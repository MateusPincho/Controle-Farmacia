...
Farmacia::Farmacia()
{
	...
	if(arquivo2.is_open()){
	    while(!arquivo2.eof()){
			...
			if (arquivo2.eof()) //Para evitar de ler alem do que � necessario.
				break;
            ...
            if (lista_comprimidos[i].get_nome() == name)
            	{
                	...
                	cout << "Codigo GTIN do Remedio � : " << lista_comprimidos[i].get_gtin() << endl;
            ...
            if (lista_comprimidos[i].get_nome() == name)
            	{
                	...
                	cout << "Codigo GTIN do Remedio � : " << lista_liquidos[i].get_gtin() << endl;
